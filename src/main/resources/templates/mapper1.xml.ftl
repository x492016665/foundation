...
<#if baseResultMap>
    <!-- 通用查询映射结果 -->
    <resultMap id="BaseResultMap" type="${package.Entity}.${entity}" extends="com.pf.dao.mapper.BaseEntityMapper.BaseResultMap">
...
<#list table.commonFields as field>
        A.${field.columnName?upper_case},
</#list>
<#list table.fields as field>
        A.${field.name?upper_case},
</#list>
